...
// Click sur icon "info" dans boutique
  ...
  $(document).on("click", ".boutique_icon_info", function(){
    ...
    $(".boutique_info_modal").show();
     initialize();
     initialize_r();
       // Click sur touche echap dans le "info" de boutique
      $(document).keydown(function(e){
        if (e.keyCode == 27) {
      ...
      // Click sur la croi dans le "info" de boutique
  ...
  // Click sur le submit dans contact
